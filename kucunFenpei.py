...
def getKucun(caigous,pinmings,early_riqi):
    datas = []
    fname1 = r'F:\a00nutstore\006\zw\2021\202111\11月份原材料盘存表.xlsx'
    kucun = pd.read_excel(fname1,'AAAAAAAA' ,usecols=[0, 1, 7])
    kucun_cailiao = kucun[kucun['本日数量']!=0]
...
def caigouLiushuizhang():
    ...
    caigous = pd.read_excel(fname, usecols=[0, 1, 2, 3, 5, 6, 7, 8, 9], index_col=0)
